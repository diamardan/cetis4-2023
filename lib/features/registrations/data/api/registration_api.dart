...
class RegistrationApi {
  ...
  RegistrationApi(this._dioClient);

  Future findByCurp(String curp) async {
    try {
      final res = await _dioClient
          .post('/registrations/find-by-curp', data: {"curp": curp});
      return res.data;
    } catch (e) {
      rethrow;
    }
  ...
  Future insertRegistration(CreateRegistrationModel registration, File? photo,
    ...
    try {
      ...
      final res = await _dioClient.post(
        '/repositions/create-registration',
        data: formData,
      );
      return res.data;
